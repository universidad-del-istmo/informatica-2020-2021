...
maurinski x = division 60 5 70 0 x
...
inicial = Modelo 0 (maurinski 0) "#003D6B"

actualizador accion (Modelo n l c) =
    case accion of
    Sumar -> Modelo (n + 1) (maurinski (n + 1)) c
    Restar -> Modelo (n - 1) (maurinski (n - 1)) c
    Amarillo -> Modelo n (maurinski n) ("#FFE61D")
    Celeste -> Modelo n (maurinski n) ("#0995FF")
    Naranja -> Modelo n (maurinski n) ("#FF9E09")
...
vista (Modelo n l color) =
    div []  [
            ...
            p
                ...
                ]       [Html.text "Cuadrado de Maurisnki"],
            div
                [] [
                    button [        
                        onClick Restar,
...
lineas coords color =
    ...
    [(a,b), (c,d), (e,f), (g,h)] :: xs -> svg [] [
        ...
        line [
                ...
                x2 (String.fromFloat g),
                y2 (String.fromFloat h),
                stroke color,
                strokeWidth "0.2"] [],
        line [
                x1 (String.fromFloat g),
                y1 (String.fromFloat h),
