...
vista (Modelo numeros) =
    div [] (List.map primeNeven (numeros))
...
primeNeven x =
    if even x 
    then if prime x 
            then (p [style "background-color" "green", style "color" "red"] [text (String.fromInt x)])
            else (p [style "color" "red"] [text (String.fromInt x)]) 
            else 
            if prime x 
            then (p [style "background-color" "green", style "color" "blue"] [text (String.fromInt x)])
            else (p [style "color" "blue"] [text (String.fromInt x)])
